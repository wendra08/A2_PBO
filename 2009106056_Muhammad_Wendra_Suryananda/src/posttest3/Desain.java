...
//      Memasukkan data ke dalam arraylist
    ...
    public static void lihatjasa()throws IOException{
        ...
        for(int i = 0; i < jasa.size(); i++){
            ...
            System.out.println("Nama Desain :" + jasa.get(i).getNamadesain());
            System.out.println("Jenis Desain :" + jasa.get(i).getJenisdesain());
            System.out.println("Ukuran Desain :" + jasa.get(i).getUkurandesain());
            System.out.println("Harga Desain :" + jasa.get(i).getHargajasa());
    ...
    public static void updatejasa()throws IOException {
        ...
        jasa.get(index).setNamadesain(namadesain);
        jasa.get(index).setJenisdesain(jenisdesain);
        jasa.get(index).setUkurandesain(ukurandesain);
        jasa.get(index).setHargajasa(hargajasa);
